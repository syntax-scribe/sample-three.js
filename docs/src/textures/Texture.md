...
|------|------|------|-------|----------|
| `_textureId` | `number` | let/var | `0` | ✗ |
| `_tempVec3` | `Vector3` | let/var | `new Vector3()` | ✗ |
...
| `output` | `{ metadata: { version: number; type: ...` | let/var | `{ metadata: { version: 4.7, type: 'Texture', generator: 'Texture.toJSON' }, u...` | ✗ |
